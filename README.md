...
안녕하세요. 컴퓨터공학을 전공하며 **Backend, Embedded System, AI/Data Analysis** 분야를 공부하고 있는 이강민입니다.

Spring Boot 기반 웹 백엔드 개발부터 STM32 기반 임베디드 시스템, PCB 설계, 센서 데이터 분석 및 예측 모델 구현까지 다양한 프로젝트를 경험하고 있습니다.
